...
const catalog: Category[] = [
  {
    ...
    courses: [
      ...
      },
      {
        ...
        titleUa: "AR-15 — Марксман (500м)",
        titleEn: "AR-15 — Marksman (500m)",
        level: "advanced",
        duration: "3 дні",
        price: 5800,
        summaryUa: "Влучна стрільба з карабіна на дистанції до 500 м: балістика, поправки, DOPE.",
  ...
  },
  {
    ...
    courses: [
      {
        slug: "ar10-marksman",
        titleUa: "АР10 — Марксман",
        titleEn: "AR-10 — Designated Marksman",
        level: "intermediate",
        duration: "3 дні",
        price: 5800,
        summaryUa: "Роль марксмана, балістика .308, DOPE та стрільба на 400–600 м.",
        instructors: ["bondar", "shevchenko"],
        items: [
          "Концепція: хто такий марксман, роль у підрозділі",
          "Конфігурація AR-10 під марксмана: ложе, сошки, оптика LPVO 1–8×",
          "Пристрілка на 100/200/300 м",
          "Балістика .308 Win: траєкторія, відхилення на вітрі",
          "Складання DOPE-таблиці та робота з нею",
          "Стрільба з опор: сошки, стіна, рюкзак, бруствер",
          "Визначення відстані без далекоміра: мільрадіан, MOA",
          "Вибір позиції: сектор обстрілу, маскування, відхід",
          "Вправи на 400–600 м: стрільба по ростовій фігурі",
          "Взаємодія з піхотою: корегування вогню, цілевказівка",
          "Стрільба по частково прикритій цілі",
        ],
      },
      {
        slug: "ar10-speed",
        ...
        duration: "2 дні",
        price: 5000,
        summaryUa: "Керування .308 на швидкості: парні постріли, Bill Drill, множинні цілі.",
        instructors: ["shevchenko", "bondar"],
        items: [
          "Чому .308 для швидкісної: переваги та виклики управління",
          "Конфігурація: дульне гальмо, компенсатор, газовий блок",
          "Дрилі на парні постріли: controlled pair, hammer",
          "Bill Drill на .308: техніка та нормативи",
          "Переміщення + стрільба по двох і більше цілях",
          "Тактична та бойова перезарядка на швидкості",
          "Усунення затримок під таймером",
          "Стрільба по множинних цілях: алфавітний та пріоритетний порядок",
          "Формати змагань: 2-gun, 3-gun — правила та тактика",
          "Тест прогресу: порівняння результатів з відео 1",
        ],
      },
      {
        ...
        duration: "3 дні",
        price: 6500,
        summaryUa: "Задачі та дистанції 50–500 м, позиції в будівлі, антидрон, контрснайпінг.",
        instructors: ["bondar"],
        items: [
          "Концепція міського снайпінгу: задачі, дистанції 50–500 м",
          "Вибір та підготовка вогневої позиції в будівлі",
          "Стрільба через вікно: тінь, дульна хвиля, підпис",
          "Стрільба з даху та балкону: кути вниз",
          "Балістика в місті: рикошети, фрагментація, перешкоди",
          "Маскування в урбані: глибина кімнати, фон, силует",
          "Переміщення між позиціями без розкриття",
          "Робота снайпера з коректувальником: кодові сигнали",
          "Антидрон: виявлення FPV, ведення, постріл",
          "Пасивна безпека: контрснайпінг та укриття",
          "Вогонь по цілях за укриттям: рикошет, обхід",
          "Тактичний відхід після розкриття позиції",
        ],
      },
      {
        slug: "ar10-vehicles",
        titleUa: "АР10 — Стрільба по транспортних засобах",
        titleEn: "AR-10 — Shooting Vehicles",
        level: "advanced",
        duration: "2 дні",
        price: 5500,
        summaryUa: "Вразливі вузли техніки на дистанціях 200–600 м.",
        instructors: ["bondar", "shevchenko"],
        items: [
          "Вразливі вузли техніки на дистанціях 200–600 м",
          "Балістика .308 по металу та склу техніки",
          "Упередження по рухомому транспорту",
          "Вибір позиції та цілевказівка",
        ],
      },
      {
        slug: "ar10-sniper-pair",
        titleUa: "АР10 — Снайперська пара: снайпер + коректувальник",
        titleEn: "AR-10 — Sniper Pair",
        level: "advanced",
        duration: "2 дні",
        price: 5500,
        summaryUa: "Розподіл ролей, спільна робота, заміна на позиції.",
        instructors: ["bondar"],
        items: [
          "Розподіл ролей у парі снайпер + коректувальник",
          "Спільна робота та кодові сигнали",
          "Корегування вогню",
          "Заміна на позиції",
        ],
      },
      {
        slug: "ar10-prs",
        titleUa: "АР10 — Змагальний PRS / NRL формат",
        titleEn: "AR-10 — PRS / NRL Competition",
        level: "intermediate",
        duration: "2 дні",
        price: 5000,
        summaryUa: "Правила, дрилі, тактика змагань точної стрільби.",
        instructors: ["bondar"],
        items: [
          "Правила форматів PRS / NRL",
          "Дрилі точної стрільби",
          "Робота з опор та нестабільних платформ",
          "Тактика та тайм-менеджмент на змаганнях",
        ],
      },
    ],
  },
